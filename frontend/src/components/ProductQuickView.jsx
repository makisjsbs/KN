        ...
        {mode === "qty" && (
          <div className="border-t border-[#EFF0F2] px-4 py-3">
            ...
            <div className="flex gap-2">
              ...
              <button data-testid="quickview-sample-button" className="secondary-button px-3" disabled={avail <= 0 || blocked}
                title="Jual sebagai sampel — harga master sampel, gudang memotong dari roll"
                onClick={() => { if (blocked || avail <= 0) return; onAdd(selected, qty, baseUnit, { is_sample: true }); onClose(); }}>
                <Scissors size={15} /> Sampel
              </button>
